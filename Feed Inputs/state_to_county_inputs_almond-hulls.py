...
# Load the CSV file
file_path = "Almond Hulls_annual_prices_dollar-per-ton.csv"
df_yearly_mean = pd.read_csv(file_path)
...
filepath_out = f'../_RuFaS Input Files/feeds_almond-hulls_dollar-per-ton.csv'
