...
crop_dict = {
    'cows-milk': {
        'file_path_state': 'cattle cows milk - price recieved dollars per head - state.csv',
...
df_crop = df_crop.loc[df_crop['Period'] == 'MARKETING YEAR']
...
#%% Save as CSV
filepath_out = f'../_RuFaS Input Files/cattle_{crop_use}-price-received_{crop_dict[crop_use]["units"]}.csv'
